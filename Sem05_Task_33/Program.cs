...
try /* Блок обработки исключений.*/
{
 ...
 начало диапозона заполнения массива, to (перевод- до)- конец диапозона заполнения массива.*/
    ...
    void checkPresence(decimal[] array)
    {
        ...
        и ни один элемент массива не равен числу (presence), наличие которого требуется проверить, то...*/
            {
                Console.WriteLine($"Число {presence} не присутствует в данном массиве.");//Выводим на экран
            }
        }
    }
}
