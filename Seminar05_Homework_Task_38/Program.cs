...
try /* Блок обработки исключений.*/
{
    ...
    void MinMax(double[] array, int i = 0, int j = 0) /* Вводим переменную (i)- это индекс элементов 
    массива в цикле по определению минимального элемента массива. Вводим переменную (j)- это индекс 
    элементов массива в цикле по определению ммаксимального элемента массива. */
    {       
        double min = array[i]; /* Вводим переменную (min)- это минимальный элемент массива. 
                                  Присвоим ему значение элемента массива с индексом (i).*/

        while (i < array.Length) /* До тех пор, пока позиция элемента массива меньше длины массива. */
        {
            ...
            i++; /* Увеличиваем значение индкса на единицу при каждой итерации.*/
        }
        Console.WriteLine($"Минимальный элемент массива равен {min}"); /*Выводим на экран.*/
        
        double max = array[j]; /* Вводим переменную (max)- это максимальный элемент массива. 
                                  Присвоим ему значение элемента массива с индексом (j).*/

        while (j < array.Length) /* До тех пор, пока позиция элемента массива меньше длины массива. */
        {
            if (max < array[j]) /* Если максимальный элемент меньше текущего элемента, то...*/
            {
                max = array[j]; /* максимальному элементу присваивается значение текущего.*/
            }
            j++; /* Увеличиваем значение индкса на единицу при каждой итерации.*/
        }
